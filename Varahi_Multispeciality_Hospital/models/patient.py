...
class HospitalPatient(models.Model):
    ...
    # partner_relation = fields.Char(string="Partner Relation")
    partner_name = fields.Char(string="Partner Name")
    # appointment_count_ids = fields.One2many('hospital.appointment', 'patient_id', string="Appointment Count Ids")
    ...
    def send_ref_by_email(self):
       template = self.env.ref('Varahi_Multispeciality_Hospital.patient_reg_temp')
       for rec in self:
